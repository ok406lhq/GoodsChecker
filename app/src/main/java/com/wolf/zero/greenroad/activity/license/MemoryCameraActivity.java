...
public class MemoryCameraActivity extends BaseActivity implements
    ...
    public ServiceConnection authConn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Toast.makeText(getApplicationContext(), com.kernal.plateid.R.string.auth_check_service_bind_success, Toast.LENGTH_SHORT).show();
            try {
...
//                            }
    ...
    public void CreatViewtoAuthservice() {
        ...
        new AlertDialog.Builder(MemoryCameraActivity.this)
                .setTitle(com.kernal.plateid.R.string.dialog_title)
                .setIcon(android.R.drawable.ic_dialog_info)
                .setView(editText)
                .setPositiveButton(com.kernal.plateid.R.string.license_verification, new DialogInterface.OnClickListener() {
